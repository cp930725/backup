<?php /*a:2:{s:68:"/www/wwwroot/aa.jdswzc.com/application/api/view/funding/publish.html";i:1562576948;s:67:"/www/wwwroot/aa.jdswzc.com/application/api/view/common/default.html";i:1562574822;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
			...
			<div class="col-md-6 col-lg-6">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" data-max="<?php echo htmlentities($maxTarget); ?>" name="max[]" placeholder="最多" />
	...
	require(['jquery'], function ($) {
		var add = function(data) {
			...
			var html = '<div class="input-group">' +
					...
					'<input type="text" class="form-control" data-max="<?php echo htmlentities($maxTarget); ?>" name="max[]" placeholder="最多" /><input type="text" class="form-control" name="bonus[]" placeholder="0.03" />' +
