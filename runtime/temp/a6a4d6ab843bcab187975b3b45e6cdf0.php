<?php /*a:2:{s:75:"/www/wwwroot/aa.jdswzc.com/application/admin/view/event/contract_store.html";i:1562574822;s:67:"/www/wwwroot/aa.jdswzc.com/application/admin/view/common/world.html";i:1562574822;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="d-flex">
    <div class="btn-list">
        ...
        <a href="/admin/event/contract_store.html" class="btn btn-primary">商品列表</a>
        ...
        <table class="table table-hover table-outline table-vcenter card-table">
            ...
            <tbody>
                <?php if(is_array($logs) || $logs instanceof \think\Collection || $logs instanceof \think\Paginator): $i = 0; $__LIST__ = $logs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><?php echo htmlentities($log['title']); ?> <span class="badge badge-default badge-md"><?php echo htmlentities(app('config')->get('hello.contract.catalog')[$log['catalog']]); ?></span><?php if(empty($log['visible']) || (($log['visible'] instanceof \think\Collection || $log['visible'] instanceof \think\Paginator ) && $log['visible']->isEmpty())): ?> <span class="badge badge-default badge-md">不可见</span><?php endif; ?></td>
                        <td><a href="/upload/<?php echo htmlentities($log['image']); ?>" target="_blank"><img src="/upload/<?php echo htmlentities($log['image']); ?>" class="w-7 h-5" /></a></td>
                        <td>
                            <span class="tag">
                            <?php switch($log['status']): case "1": ?>空闲<?php break; case "2": ?>一口价<?php break; case "3": ?>团购<?php break; endswitch; ?>
                            </span>
                        </td>
                        <td><?php echo htmlentities(money($log['base_price'])); ?></td>
                        <td><?php echo htmlentities(money($log['now_price'])); ?></td>
                        <td><?php echo htmlentities(money($log['inc'])); ?></td>
                        <td><?php echo htmlentities(money($log['charge'])); ?></td>
                        <td><?php echo htmlentities($log['loop']); ?></td>
                        <td>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <!-- <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-label">每秒收益</label>
                                <input type="text" class="form-control" placeholder="小于等于0表示没有收益" name="profit" />
                            </div>
                        </div> -->
                        <div class="col-lg-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="代理商手机号码" name="agent" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-label">归属人（修改归属人将自动执行转让）</label>
                                <input type="text" class="form-control" placeholder="归属人手机号码" name="owner" />
                            </div>
                        </div> -->
                        <div class="col-lg-6">
                            <div class="form-group">
...
require(['jquery', 'ZeroClipboard'], function($, ZeroClipboard){
    ...
    $(function(){
        ...
        $('.btn-edit').on('click', function(){
            ...
            var id = $(this).data('id');
            ajax('/admin/event/contract_store', {action: 'get', id: id}, function(res){
