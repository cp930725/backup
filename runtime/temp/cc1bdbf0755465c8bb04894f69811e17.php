<?php /*a:2:{s:71:"/www/wwwroot/aa.jdswzc.com/application/admin/view/market/bonus_log.html";i:1562574822;s:67:"/www/wwwroot/aa.jdswzc.com/application/admin/view/common/world.html";i:1562662267;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="card">
	    ...
	    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
	        <thead>
	            <tr>
	                ...
	                <th>总金额</th>
	                <th>#</th>
	                <?php $__FOR_START_729790550__=0;$__FOR_END_729790550__=9;for($i=$__FOR_START_729790550__;$i < $__FOR_END_729790550__;$i+=1){ ?>
	                	<th>Lv<?php echo htmlentities($i); ?></th>
	                <?php } ?>
	            </tr>
	        </thead>
	        <tbody>
			<?php if(is_array($gbs) || $gbs instanceof \think\Collection || $gbs instanceof \think\Paginator): $a = 0; $__LIST__ = $gbs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gb): $mod = ($a % 2 );++$a;?>
				<tr>
					<td rowspan="3" colspan="1"><?php echo htmlentities($gb['date']); ?></td>
					<td rowspan="3" colspan="1"><?php echo htmlentities($gb['charge']); ?></td>
					<td rowspan="3" colspan="1"><?php echo htmlentities($gb['people']); ?></td>
					<td rowspan="3" colspan="1"><?php echo htmlentities($gb['money']); ?></td>
					<th class="text-left">人数</th>
					<?php $__FOR_START_1496842978__=0;$__FOR_END_1496842978__=9;for($b=$__FOR_START_1496842978__;$b < $__FOR_END_1496842978__;$b+=1){ ?>
						<td><?php echo htmlentities($gb['lv'.$b]['count']); ?></td>
					<?php } ?>
				</tr>
				<tr>
					<th class="text-left pl-3">金额</th>
					<?php $__FOR_START_1652609842__=0;$__FOR_END_1652609842__=9;for($c=$__FOR_START_1652609842__;$c < $__FOR_END_1652609842__;$c+=1){ ?>
						<td><?php echo htmlentities($gb['lv' . $c]['money']); ?></td>
					<?php } ?>
				</tr>
				<tr>
					<th class="text-left pl-3">比例</th>
					<?php $__FOR_START_1096038433__=0;$__FOR_END_1096038433__=9;for($d=$__FOR_START_1096038433__;$d < $__FOR_END_1096038433__;$d+=1){ ?>
						<td><?php echo htmlentities($gb['lv' . $d]['rate']); ?></td>
					<?php } ?>
				</tr>
	...
	<div class="card-footer"><?php echo $gbs; ?></div>
</div>
