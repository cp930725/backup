<?php /*a:2:{s:68:"/www/wwwroot/aa.jdswzc.com/application/api/view/funding/welcome.html";i:1562574822;s:67:"/www/wwwroot/aa.jdswzc.com/application/api/view/common/default.html";i:1562661391;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
	...
	<div class="card-body">
		<div class="table-responsive">
			...
			<div class="text-muted jeishao">
				...
				<div><?php echo htmlentities(app('config')->get('hello.title')); ?>的每个会员可发起项目众筹获得其他会员的GGFB支持，发起人在项目成功后用产品或服务回馈支持自己的会员，支持其他众筹项目可以获得奖章(美心)，不同等级的奖章代表您可以发起众筹的最高金额，支持其他会员发起的众筹项目越多，自己发布的众筹项目会得到优先支持权。</div>
			</div>
