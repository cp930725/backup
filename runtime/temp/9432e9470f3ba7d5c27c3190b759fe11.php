<?php /*a:2:{s:66:"/www/wwwroot/aa.jdswzc.com/application/admin/view/index/popup.html";i:1562574822;s:67:"/www/wwwroot/aa.jdswzc.com/application/admin/view/common/world.html";i:1562662267;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<form class="card" method="post">
	<div class="card-header">
		<div class="card-title">弹窗公告</div>
		<div class="card-options">
			<label class="custom-switch m-0">
				<?php if(empty($popup['switch']) || (($popup['switch'] instanceof \think\Collection || $popup['switch'] instanceof \think\Paginator ) && $popup['switch']->isEmpty())): ?>
                	<input type="checkbox" value="1" class="custom-switch-input" name="switch" />
				<?php else: ?>
                	<input type="checkbox" value="1" class="custom-switch-input" checked="" name="switch" />
				<?php endif; ?>
	...
	<div class="card-body">
        <div class="form-group">
            <script id="editor" name="content" type="text/plain" style="height: 20rem;"><?php echo $popup['content']; ?></script>
        </div>
	</div>
