<?php /*a:2:{s:67:"/www/wwwroot/aa.jdswzc.com/application/admin/view/store/create.html";i:1562574822;s:67:"/www/wwwroot/aa.jdswzc.com/application/admin/view/common/world.html";i:1562662267;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
				...
				<div class="row">
				    ...
				    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select" name="catalog">
                            	<?php if(is_array(app('config')->get('hello.store.catalog')) || app('config')->get('hello.store.catalog') instanceof \think\Collection || app('config')->get('hello.store.catalog') instanceof \think\Paginator): $i = 0; $__LIST__ = app('config')->get('hello.store.catalog');if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                    ...
                    <div class="col-sm-12 attr-machine">
                    	<div class="form-group">
                            ...
                            <select class="form-control custom-select" name="divide">
                            	<?php $__FOR_START_1999505707__=0;$__FOR_END_1999505707__=9;for($i=$__FOR_START_1999505707__;$i < $__FOR_END_1999505707__;$i+=1){ ?>
                    ...
                    <div class="col-sm-4">
				        <div class="form-group">
				            ...
				            <input type="text" class="form-control" name="price" placeholder="使用<?php echo htmlentities(app('config')->get('hello.unit')); ?>付款需要多少" />
				        </div>
				    </div>
				    <div class="col-sm-4">
				        <div class="form-group">
				            <label class="form-label">商品价格（<?php echo htmlentities(app('config')->get('hello.score.unit')); ?>）</label>
				            <input type="text" class="form-control" name="price_score" placeholder="可选，使用<?php echo htmlentities(app('config')->get('hello.score.unit')); ?>付款需要多少" />
				        </div>
				    </div>
				    <div class="col-sm-4">
				        <div class="form-group">
