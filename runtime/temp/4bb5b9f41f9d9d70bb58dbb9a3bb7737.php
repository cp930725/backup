...
<?php if(empty(app('request')->param())): ?>
	<a href="<?php echo htmlentities(app('config')->get('hello.appurl')); ?>">app下载</a>  已有账号了? <a href="/signin.html">立即登录</a>
<?php else: ?>
	<a href="<?php echo htmlentities(app('config')->get('hello.appurl')); ?>">app下载</a>  已有账号了? <a href="/signin.html?<?php echo query(app('request')->query()); ?>">立即登录</a>
<?php endif; ?>
</div>
