<?php /*a:2:{s:72:"/www/wwwroot/aa.jdswzc.com/application/admin/view/account/dashboard.html";i:1562574822;s:67:"/www/wwwroot/aa.jdswzc.com/application/admin/view/common/world.html";i:1562662267;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
	    ...
	    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
	        ...
	        <tbody>
	            ...
	            <tr>
	                ...
	                <td><?php echo htmlentities(money($user['power'])); ?></td>
	                <td><?php echo htmlentities(money($user['team_power'])); ?></td>
	                <td><?php echo htmlentities(money($user['machine_power'])); ?></td>
	                <td><?php echo htmlentities($user['team_count']); ?></td>
	                <td><?php echo htmlentities($user['machine_count']); ?></td>
	                <td><?php echo htmlentities($user['machine_expire']); ?></td>
	                <td>
