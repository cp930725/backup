<?php /*a:2:{s:65:"/www/wwwroot/aa.jdswzc.com/application/admin/view/index/help.html";i:1562574822;s:67:"/www/wwwroot/aa.jdswzc.com/application/admin/view/common/world.html";i:1562662267;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<form class="card" method="post">
	...
	<div class="card-body">
        <div class="form-group">
            <script id="editor" name="content" type="text/plain" style="height: 20rem;"><?php echo $article['content']; ?></script>
        </div>
	</div>
